        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarmain">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ route('ai.checkup') }}">{{ __('menu.ai_checkup') }}</a></li>
                    <li class="nav-item"><a class="nav-link" href="javascript:void(0)" id="ai-chat-link">Chat AI</a></li>
