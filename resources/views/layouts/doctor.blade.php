...
<head>
    ...
    <meta name="description" content="Doctor Dashboard for Medical Clinic">
    <meta name="author" content="Your Name">
    
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>{{ config('app.name', 'Laravel') }} - Bác sĩ</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Pending Patients -->
            <li class="nav-item {{ (request()->is('doctor/patients/pending*')) ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('doctor.patients.pending') }}">
                    <i class="fas fa-user-injured"></i>
                    <span>Bệnh nhân chờ khám</span>
                </a>
            </li>

            <!-- Nav Item - Patient History -->
            <li class="nav-item {{ (request()->is('doctor/patients/history*')) ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('doctor.patients.history') }}">
