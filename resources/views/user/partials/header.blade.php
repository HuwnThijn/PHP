            ...
            <div class="collapse navbar-collapse" id="navbarmain">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="department.blade.php" id="dropdown02"
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown02">
                            ...
                            <li><a class="dropdown-item" href="department-single.blade.php">Department Single</a>
                            </li>
                            ...
                            <li class="dropdown dropdown-submenu dropright">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdown0301">
                                    <li><a class="dropdown-item" href="index.blade.php">Submenu 01</a></li>
                                    <li><a class="dropdown-item" href="index.blade.php">Submenu 02</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="doctor.blade.php" id="dropdown03"
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown03">
                            ...
                            <li><a class="dropdown-item" href="doctor-single.blade.php">Doctor Single</a></li>
                            <li><a class="dropdown-item" href="appoinment.blade.php">Appoinment</a></li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="blog-sidebar.blade.php" id="dropdown05"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Blog <i
                                class="icofont-thin-down"></i></a>
                        <ul class="dropdown-menu" aria-labelledby="dropdown05">
                            <li><a class="dropdown-item" href="blog-sidebar.blade.php">Blog with Sidebar</a></li>
                            <li><a class="dropdown-item" href="blog-single.blade.php">Blog Single</a></li>
                        </ul>
                    </li>
