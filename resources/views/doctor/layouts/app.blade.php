...
<head>
    ...
    <title>@yield('title') - Hệ thống Bác sĩ</title>
    ...
    <style>
        ...
        .sidebar {
            min-height: 100vh;
            background: linear-gradient(180deg, var(--primary-color) 10%, #258391 100%);
    ...
    <div class="d-flex">
        ...
        <div class="sidebar col-lg-2 col-md-3 px-0">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('doctor.patients.pending') ? 'active' : '' }}" href="{{ route('doctor.patients.pending') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('doctor.patients.history') ? 'active' : '' }}" href="{{ route('doctor.patients.history') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('doctor.schedules.*') ? 'active' : '' }}" href="{{ route('doctor.schedules.index') }}">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" width="32" height="32"
                                    src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=36b9cc&color=ffffff">
                            </a>
