                ...
                <div class="col-lg-6 col-md-12 col-xl-7">
                    <div class="block">
                        ...
                        <div class="btn-container ">
                            <a href="appoinment.blade.php" target="_blank"
                    ...
                    <div class="feature-block d-lg-flex">
                        <div class="feature-item mb-5 mb-lg-0">
                            ...
                            <p class="mb-4">Get ALl time support for emergency.We have introduced the principle of
                                family medicine.</p>
                            <a href="appoinment.blade.php" class="btn btn-main btn-round-full">Make a appoinment</a>
                        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    <div class="about-content pl-4 mt-4 mt-lg-0">
                        ...
                        <a href="service.blade.php" class="btn btn-main-2 btn-round-full btn-icon">Services<i
                ...
                <div class="col-lg-6 col-md-10 ">
                    <div class="appoinment-wrap mt-5 mt-lg-0">
                        ...
                        <form id="#" class="appoinment-form" method="post" action="#">
                            ...
                            <a class="btn btn-main btn-round-full" href="appoinment.blade.php">Make Appoinment <i
                                    class="icofont-simple-right ml-2  "></i></a>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-lg-12 testimonial-wrap-2">
                    <div class="testimonial-block style-2  gray-bg">
                        ...
                        <div class="testimonial-thumb">
                            <img src="{{ asset('user/theme/images/team/test-thumb1.jpg') }}" alt=""
                                class="img-fluid">
                        </div>
                    ...
                    <div class="testimonial-block style-2  gray-bg">
                        <div class="testimonial-thumb">
                            <img src="{{ asset('user/theme/images/team/test-thumb2.jpg') }}" alt=""
                                class="img-fluid">
                        </div>
                    ...
                    <div class="testimonial-block style-2  gray-bg">
                        <div class="testimonial-thumb">
                            <img src="{{ asset('user/theme/images/team/test-thumb3.jpg') }}" alt=""
                                class="img-fluid">
                        </div>
                    ...
                    <div class="testimonial-block style-2  gray-bg">
                        <div class="testimonial-thumb">
                            <img src="{{ asset('user/theme/images/team/test-thumb4.jpg') }}" alt=""
                                class="img-fluid">
                        </div>
